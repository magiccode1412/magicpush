...
// 方式1: Token 在 URL 路径中
router.get('/:token', pushController.pushByToken);
router.post('/:token', pushMessageValidation, pushController.pushByToken);

// 方式2: Token 在 Authorization 头中 (更安全)
router.post('/', pushMessageValidation, pushController.pushByToken);
